(ns pismail.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [pismail.routes.home :refer [home-routes]]
            [pismail.routes.api :refer [api-routes]]
            [pismail.middleware :as middleware]
            [pismail.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "pismail is shutting down...")
  (stop-nrepl)
